// Andre Hitcchman
// this sketch uses the promidi libaray to receive inputs from a midi device
// this is then translate and used to display shapes and colours 

import promidi.*;

// create new type of MidiIo
MidiIO midiIO;
...
void noteOn (Note note) { // if note is pressed excute this function
  ...
  // fill based on arthimetic with velocity & pitchvalue variable
...
void noteOff (Note off) {
  ...
  // fill based on arthimetic with pitchvalue variable
...
void controllerIn (Controller controller) {
  ...
  // fill based on arthimetic with number & value variable
...
void programChange (ProgramChange programChange) {
  ...
  // fill based on arthimetic with number variable

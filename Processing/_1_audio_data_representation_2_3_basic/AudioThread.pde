...
public class AudioThread extends Thread {
  ...
  AudioThread (){
   ...
   // mono
    ...
    blockSize = 4096;
    sampleRate = 44100; // alter this to change speed of audio playback
    //sampleRate = 44100*2; // alter this to play the audio faster
    //sampleRate = 44100/3;  // higher rate for faster aduio & lower rate for slower audio
    bitDepth = 16;
  ...
  // we are overriding the run method from the Thread class

class Bullet {
  ...
  void bulletMovement () {
    ...
    println("bullet loc x: "+bulletLocation.x);
    println("bullet loc y: "+bulletLocation.y);
...
//    //pushMatrix();
//    ellipseMode(CENTER);
//    fill(colorCurrently); // colour of bullet
//    //ellipse(x+bulletLocation.x, bulletLocation.y, bulletCurcumference, bulletCurcumference); // bullet
//    ellipse(bulletLocation.x+hurt.characterLocation.x, hurt.characterLocation.y, bulletCurcumference, bulletCurcumference); 
//    x++;
//    
//    noFill();
//    //popMatrix();
